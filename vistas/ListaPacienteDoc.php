...
<main class="container py-4">
  ...
  <div class="mb-3 d-flex justify-content-between">
    <a href="PacienteRegistroD.php" class="btn btn-success">Registrar Nuevo Paciente</a>
    ...
    <tbody>
      <?php foreach ($pacientes as $pac): ?>
        <tr>
          ...
          <td>
            <a href="PacienteRegistroD.php?id=<?= $pac->id ?>" class="btn btn-warning btn-sm">Editar</a>
